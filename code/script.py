...
# output format-
'''vertex,edges,graph-construct,dijkstra,dijkstra-average,oracle-contruct,oracle-dist,average-query,average-total,Floyd-Warshal,fw-average'''
